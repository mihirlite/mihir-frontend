...
const ExploreMenu = ({ category, setCategory }) => {
    return (
        <div className='flex flex-col gap-6 md:gap-8 pt-12 md:pt-16 pb-8 animate-fadeIn' id='explore-menu'>
            <div className='flex flex-col md:flex-row md:items-end justify-between gap-4 items-center md:items-start'>
                <div className='max-w-2xl flex flex-col items-center md:items-start text-center md:text-left'>
                    <div className='flex items-center justify-center md:justify-start gap-3 mb-2'>
                        <span className='w-2 h-8 bg-orange-500 rounded-full'></span>
                        <h1 className='text-gray-800 font-extrabold text-3xl md:text-4xl tracking-tight text-center md:text-left uppercase'>Explore our menu</h1>
                    </div>
