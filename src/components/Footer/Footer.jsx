            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-12 md:gap-20 text-center md:text-left'>
                ...
                <div className="flex flex-col items-center md:items-start gap-5">
                    ...
                    <ul className='list-none space-y-3'>
                        ...
                        <Link to='/return-policy'><li className='cursor-pointer text-gray-400 hover:text-orange-500 transition-all duration-300 hover:translate-x-1'>Return Policy</li></Link>
                        <Link to='/refund-policy'><li className='cursor-pointer text-gray-400 hover:text-orange-500 transition-all duration-300 hover:translate-x-1'>Refund Policy</li></Link>
                        <Link to='/privacy-policy'><li className='cursor-pointer text-gray-400 hover:text-orange-500 transition-all duration-300 hover:translate-x-1'>Privacy Policy</li></Link>
                        ...
                        <Link to='/disclaimer'><li className='cursor-pointer text-gray-400 hover:text-orange-500 transition-all duration-300 hover:translate-x-1'>Disclaimer</li></Link>
                        <Link to='/shipping-policy'><li className='cursor-pointer text-gray-400 hover:text-orange-500 transition-all duration-300 hover:translate-x-1'>Shipping & Delivery</li></Link>
                        <Link to='/about-contact'><li className='cursor-pointer text-gray-400 hover:text-orange-500 transition-all duration-300 hover:translate-x-1'>About & Contact</li></Link>
                    </ul>
                </div>
                <div className="flex flex-col items-center md:items-start gap-5">
