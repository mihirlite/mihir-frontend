...
const Edit = ({ url, token }) => {
    ...
    return (
        <div className='animate-fadeIn'>
            <div className='mb-8'>
                <h3 className='text-3xl font-black text-gray-900 mb-1 tracking-tight'>Edit Product</h3>
                <p className='text-sm text-gray-500 font-medium'>Update the details of your food item</p>
            </div>
            ...
            <form className='grid grid-cols-1 lg:grid-cols-12 gap-10' onSubmit={onSubmitHandler}>
                ...
                <div className="lg:col-span-4 flex flex-col gap-3">
                    ...
                    <label htmlFor="image" className='group cursor-pointer'>
                        <div className={`
                            ...
                            ${(images.length > 0 || existingImages.length > 0) ? 'border-orange-500 bg-orange-50/50 shadow-inner' : 'border-gray-200 bg-gray-50 hover:border-orange-400 hover:bg-orange-50/30'}
                        `}>
                            {images.length > 0 ? (
                                ...
                                <div className='grid grid-cols-2 gap-3 w-full'>
                                    {existingImages.map((img, index) => (
                                        <div key={index} className='aspect-square rounded-2xl overflow-hidden shadow-md ring-2 ring-white'>
                                            <img src={getImageUrl(img)} className='w-full h-full object-cover transform hover:scale-110 transition-transform duration-500' alt="" />
                                        </div>
                                    ))}
                                </div>
                            ) : (
                ...
                <div className="lg:col-span-8 flex flex-col gap-6">
                    ...
                    <div className="flex gap-4">
                        <button type='submit' className='mt-4 w-full md:w-fit px-12 py-4 bg-orange-500 text-white font-black rounded-2xl hover:bg-orange-600 transition-all hover:scale-[1.02] active:scale-95 shadow-lg shadow-orange-100 flex items-center justify-center gap-2'>
                            Update Product
                        </button>
                        <button type='button' onClick={() => navigate('/master-control-gate/list')} className='mt-4 w-full md:w-fit px-12 py-4 bg-gray-100 text-gray-600 font-black rounded-2xl hover:bg-gray-200 transition-all active:scale-95'>
                            Cancel
                        </button>
                    </div>
                </div>
